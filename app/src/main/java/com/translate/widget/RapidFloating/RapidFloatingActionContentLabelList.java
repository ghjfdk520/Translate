...
public class RapidFloatingActionContentLabelList extends RapidFloatingActionContent implements View.OnClickListener {
    ...
    protected void initInConstructor() {
        rfacItemDrawableSizePx = Utils.dip2px(getContext(), RFABConstants.SIZE.RFAC_ITEM_DRAWABLE_SIZE_DP);
    ...
    private void refreshItems() {
        ...
        for (int i = 0, size = items.size(); i < size; i++) {
            ...
            View rootView = Utils.obtainView(itemView, R.id.rfab__content_label_list_root_view);

            TextView labelTv = Utils.obtainView(itemView, R.id.rfab__content_label_list_label_tv);
            ImageView iconIv = Utils.obtainView(itemView, R.id.rfab__content_label_list_icon_iv);
            ...
            int minPadding =  Utils.dip2px(getContext(), 8);
            ...
            Utils.setBackgroundDrawable(iconIv, Utils.selectorClickSimple(rfacNormalDrawable, rfacPressedDrawable));
            // 设置中间图标的大小
            int padding = Utils.dip2px(getContext(), 8) + shadowOffsetHalf;
            ...
            if (Utils.isEmpty(label)) {
                ...
                if (null != bgDrawable) {
                    Utils.setBackgroundDrawable(labelTv, bgDrawable);
                }
            ...
            if (null != drawable) {
                ...
                iconIv.setVisibility(VISIBLE);
                iconIv.setImageDrawable(Utils.getResourceDrawableBounded(getContext(), resId, rfacItemDrawableSizePx));
            } else {
    ...
    public void onExpandAnimator(AnimatorSet animatorSet) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            ImageView iconIv = Utils.obtainView(rootView, R.id.rfab__content_label_list_icon_iv);
            if (null == iconIv) {
                return;
            }
            ...
            animator.setStartDelay((count * i) * 10);
