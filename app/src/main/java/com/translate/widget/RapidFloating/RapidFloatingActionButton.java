...
public class RapidFloatingActionButton extends FrameLayout implements View.OnClickListener {
     ...
     * 默认的drawable
     */
    private static final int DEFAULT_BUTTON_DRAWABLE_RES_ID = R.mipmap.ic_launcher;
    /**
     * 中间图片大小24dp
     */
    ...
    private void initAfterConstructor() {
        ...
        // 中间图片大小24dp
        buttonDrawableSize = Utils.dip2px(getContext(), RFABConstants.SIZE.RFAB_DRAWABLE_SIZE_DP);
    ...
    private void refreshRFABDisplay() {
        if (null == buttonDrawable) {
            buttonDrawable = Utils.getResourceDrawableBounded(getContext(), DEFAULT_BUTTON_DRAWABLE_RES_ID, buttonDrawableSize);
        }
