...
public class CommonUtil {
    ...
    public static boolean isNetworkAvailable(Context context) {
        if (checkPermissions(context, "android.permission.INTERNET")) {
            ...
            if (info != null && info.isAvailable()) {
                ...
                LogUtils.e("error", "Network error");
                return false;
            }
        } else {
            LogUtils.e("lost permission", "android.permission.INTERNET");
            return false;
        }
    }
    ...
    public static String getSdkVersion(Context context) {
        ...
        if (checkPhoneState(context)) {
            ...
            LogUtils.d("android_osVersion", "OsVerson" + osVersion);
            return osVersion;
        } else {
    ...
    public static String getDeviceID(Context context) {
        if (checkPermissions(context, "android.permission.READ_PHONE_STATE")) {
            ...
            if (deviceId != null) {
                LogUtils.d("commonUtil", "deviceId:" + deviceId);
                return deviceId;
            } else {
                LogUtils.e("commonUtil", "deviceId is null");
                return null;
            }
        } else {
            LogUtils.e("lost permissioin",
    ...
    public static boolean isNetworkTypeWifi(Context context) {
        ...
        if (info != null && info.isAvailable()
            ...
            LogUtils.e("error", "Network not wifi");
            return false;
        }
    }
